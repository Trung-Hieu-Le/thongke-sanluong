...
class TinhSanLuongFilterController extends Controller
{
    ...
    (
        ...
        LEFT JOIN tbl_tinh ON LEFT(subquery_sanluong.SanLuong_Tram, 3) = tbl_tinh.ma_tinh
...
"))
    ...
    (
        ...
        LEFT JOIN tbl_tinh ON LEFT(subquery.SanLuong_Tram, 3) = tbl_tinh.ma_tinh
        LEFT JOIN tbl_hopdong ON subquery.HopDong_Id = tbl_hopdong.HopDong_Id
        WHERE 1
        $dayCondition
        $searchCondition
        $searchConditionHopDong
